...
- You can generate the first required event related to adding recipes to a recipe book by...
- You can generate the first required event related to adding restaurants to a restaurant list by...
- You can generate the second required event related to adding recipes to a recipe book by...
- You can generate the second required event related to adding restaurants to a restaurant list by...
